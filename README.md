...
* [3.8, 3.8.1, latest](https://github.com/nextgenhealthcare/connect-docker/blob/master/Dockerfile)
* [3.8.0](https://github.com/nextgenhealthcare/connect-docker/blob/3.8.0/Dockerfile)

##### Oracle OpenJDK 11 with full JDK
* [3.8-jdk, 3.8.1-jdk, latest-jdk](https://github.com/nextgenhealthcare/connect-docker/blob/master/Dockerfile-jdk)
* [3.8.0-jdk](https://github.com/nextgenhealthcare/connect-docker/blob/3.8.0/Dockerfile-jdk)

##### Zulu OpenJDK 11 (Alpine Linux)
* [3.8-zulu-alpine, 3.8.1-zulu-alpine, latest-zulu-alpine](https://github.com/nextgenhealthcare/connect-docker/blob/master/Dockerfile-zulu-alpine)
...
* [3.8-zulu-alpine-jdk, 3.8.1-zulu-alpine-jdk, latest-zulu-alpine-jdk](https://github.com/nextgenhealthcare/connect-docker/blob/master/Dockerfile-zulu-alpine-jdk)
...
* [3.8-adoptopenjdk-openj9-alpine, 3.8.1-adoptopenjdk-openj9-alpine, latest-adoptopenjdk-openj9-alpine](https://github.com/nextgenhealthcare/connect-docker/blob/master/Dockerfile-adoptopenjdk-openj9-alpine)
...
* [3.8-adoptopenjdk-openj9-alpine-jdk, 3.8.1-adoptopenjdk-openj9-alpine-jdk, latest-adoptopenjdk-openj9-alpine-jdk](https://github.com/nextgenhealthcare/connect-docker/blob/master/Dockerfile-adoptopenjdk-openj9-alpine-jdk)
